					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "For CI/CD Demo",
									"targetURL": "#cicddemo-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"cicddemo-display": {
								"semanticObject": "cicddemo",
								"action": "display",
								"description": "For CI/CD Demo",
								"title": "For CI/CD Demo",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=cicddemo",
									"url": sap.ui.require.toUrl("cicddemo")
								}
							}
						}
					}
